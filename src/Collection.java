...
public class Collection {
    ...
    StudyGroup addElement() {
        ...
        c.setY(null);
            ...
            while (!Main.isNormalCoordinates(c)) {
                c.setX(null);
                c.setY(null);
                System.out.print("Please enter X coordinate ");
                str = scanner.nextLine();
                Float X = Main.toCoordinatesX(str);
                //System.out.println(X);
                System.out.print("Please enter Y coordinate ");
                str = scanner.nextLine();
                Integer Y = Main.toCoordinatesY(str);
        ...
        while (!Main.isNormalLocation(location) ) {
            location.setLocation(null, null, null, null);
            System.out.print("Please enter X coordinate ");
            str = scanner.nextLine();
            Long X = Main.toLocation(str);
            //System.out.println(X);
            System.out.print("Please enter Y coordinate ");
            str = scanner.nextLine();
            Long Y = Main.toLocation(str);
            //System.out.println(Y);
            System.out.print("Please enter Z coordinate ");
            str = scanner.nextLine();
            Long Z = Main.toLocation(str);
    ...
    public StudyGroup addFromFile(Scanner scanner) {
        try {
            ...
            group.setFormOfEducation(Main.findEnum1(scanner.nextLine()));
            group.setSemesterEnum(Main.findEnum2(scanner.nextLine()));
            StudyGroup.Person person = new StudyGroup.Person();
